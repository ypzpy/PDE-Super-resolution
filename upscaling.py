...
class UpScaleBy4(torch.nn.Module):
    def __init__(self):
        ...
        self.layer1 = torch.nn.Conv2d(in_channels=1, out_channels=25, kernel_size=3, stride=1,padding=1)
        self.layer2 = torch.nn.Conv2d(in_channels=25, out_channels=50, kernel_size=3, stride=1,padding=1)
        self.layer3 = torch.nn.Conv2d(in_channels=50, out_channels=16, kernel_size=3, stride=1,padding=1)
        self.layer4 = torch.nn.Conv2d(in_channels=1, out_channels=1, kernel_size=3, stride=1,padding=1)
        self.PReLU = torch.nn.PReLU()
        self.act1 = torch.nn.ReLU()
...
class UpScaleByBicubic(torch.nn.Module):
    def __init__(self):
        super(UpScaleByBicubic, self).__init__()
        self.layer1 = torch.nn.Conv2d(in_channels=1, out_channels=8, kernel_size=3, stride=1,padding=1)
        self.layer2 = torch.nn.Conv2d(in_channels=8, out_channels=16, kernel_size=3, stride=1,padding=1)
        self.layer3 = torch.nn.Conv2d(in_channels=16, out_channels=16, kernel_size=3, stride=1,padding=1)
...
class BicubicCorrection(torch.nn.Module):
    def __init__(self):
        super(BicubicCorrection, self).__init__()
        self.layer1 = torch.nn.Conv2d(in_channels=1, out_channels=8, kernel_size=3, stride=1,padding=1)
        self.layer2 = torch.nn.Conv2d(in_channels=8, out_channels=16, kernel_size=3, stride=1,padding=1)
        self.layer3 = torch.nn.Conv2d(in_channels=16, out_channels=16, kernel_size=3, stride=1,padding=1)
        self.layer4 = torch.nn.Conv2d(in_channels=16, out_channels=8, kernel_size=3, stride=1,padding=1)
